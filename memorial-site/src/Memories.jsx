    ...
    <div>
      ...
      <section className="mem-hero">
        ...
        <p className="mem-hero-subtitle">
          Share what Dada meant to you &mdash; a happy memory, a lesson he taught you, or a few words of condolence. Choose to display your message on the board below, or keep it private for just the immediate family to read.
        </p>
        <p className="mem-hero-subtitle-hindi">
          दादा जी आपके लिए क्या मायने रखते थे &mdash; कोई खुशी की याद, उनकी कोई सीख, या श्रद्धांजलि के कुछ शब्द। अपना संदेश नीचे बोर्ड पर दिखाएँ, या सिर्फ़ परिवार के लिए निजी रखें।
        </p>
        {GOOGLE_FORM_URL && (
          <a
